      ...
      })(
        {
          ...
          8: [
            (t, r) => {
              ...
              const o = t => {
                ...
                const r = n(t), o = [r.finish], s = new e(t.directed);
          ...
          11: [
            (t, r) => {
              ...
              const n = t => {
                if (t.directed)
                  throw new Error("Can't build MST of a directed graph.");
                const r = new i(!1), n = Object.create(null), o = new e();
                t.vertices.forEach(t => {
                  o.insert(t, 1 / 0);
                });
                for (
                  ...
                  const a = o.extract(!0), h = a.item, u = a.priority;
          ...
          35: [
            (t, r) => {
              ...
              const i = (t, r) => {
                ...
                return (function t(r) {
                  if (r.length > 1) {
                    const e = r.length >> 1, o = t(r.slice(0, e)), s = t(r.slice(e));
                    r = n(o, s, i);
                  }
                  return r;
                })(t);
          ...
          37: [
            (t, r) => {
              ...
              const i = (t, r) => {
                ...
                for (e = 0; i > e; e++) {
                  const o =
                    parseInt((t[e].key / 10 ** r).toFixed(r)) % 10;
                  n[o].push(t[e]);
                }
                let s = 0;
                for (e = 0; 10 > e; e++)
                  for (let a = n[e].length, h = 0; a > h; h++)
                    t[s++] = n[e][h];
                return t;
              };
          ...
          39: [
            (t, r) => {
              ...
              const i = (t, r) => {
                for (
                  let i = new e(r), n = 0, o = t.length - 1, s = parseInt((o - n + 1) / 2), a = 0, h = 0, u = 0;
                  s >= 1;
