      ...
      return (function t(r, e, i) {
      ...
      })(
        {
          ...
          2: [
            function (t, r) {
              ...
              function e(t, r) {
                ...
                for (var u; a !== h; ) {
                  (u = n[a++]), (o[u] = !1);
                  for (var l = t.neighbors(u), c = 0; c < l.length; c++) {
                    var f = l[c],
                      p = e[u] + t.edge(u, f);
                    if (
                      p < e[f] &&
          ...
          6: [
            function (t, r) {
              ...
              var e = function (t, r) {
                ...
                n = function t(r, e, i) {
                  i.enterVertex(e),
                    r.neighbors(e).forEach(function (n) {
          ...
          8: [
            function (t, r) {
              "use strict";
              var e = t("../../data_structures/graph"),
                i = t("../../algorithms/graph/depth_first_search"),
                n = function (t) {
                  var r = {};
                  if (
                ...
                o = function (t) {
                  ...
                  var r = n(t),
                    o = [r.finish],
                    s = new e(t.directed);
                  return t.vertices.forEach(s.addVertex.bind(s)),
                  i(t, r.start, {
                    allowTraversal(t, r) {
                      return !s.edge(t, r);
                    },
          ...
          10: [
            function (t, r) {
              "use strict";
              var e = t("../../data_structures/disjoint_set_forest"),
                i = t("../../data_structures/graph"),
                n = function (t) {
                  if (t.directed)
                    ...
                    o
                      ...
                      .forEach(function (t) {
                        r.sameSubset(t.ends[0], t.ends[1]) ||
                          (n.addEdge(t.ends[0], t.ends[1], t.weight),
          ...
          11: [
            function (t, r) {
              "use strict";
              var e = t("../../data_structures/priority_queue"),
                i = t("../../data_structures/graph"),
                n = function (t) {
                  if (t.directed)
                    throw new Error("Can't build MST of a directed graph.");
          ...
          12: [
            function (t, r) {
              "use strict";
              var e = t("../../data_structures/stack"),
                i = t("../../algorithms/graph/depth_first_search"),
                n = function (t) {
                  var r = new e(),
                    n = {},
                    o = 0;
                  return t.vertices.forEach(function (e) {
                    n[e] ||
                      i(t, e, {
                        allowTraversal(t, r) {
                          return !n[r];
          ...
          23: [
            function (t, r) {
              ...
              var e = function (t) {
                  ...
                  for (r = 0; r < Math.pow(2, t.length); r++) {
                    e.push([]);
                    for (var n = 0; n < t.length; n++)
                      r % Math.pow(2, n) === 0 && (i[n] = !i[n]),
                        i[n] && e[r].push(t[n]);
                  }
                  return e;
                },
          ...
          24: [
            function (t, r) {
              ...
              var e = function (t, r) {
                ...
                i = function (t) {
                  for (var r = 2; t > r; ++r) if (t % r === 0) return !1;
                  return !0;
                },
                n = function (t) {
                  for (var r = Math.sqrt(t), e = 2; r >= e; ++e)
                    if (t % e === 0) return !1;
                  return !0;
                };
              r.exports = {
          ...
          27: [
            function (t, r) {
              "use strict";
              var e = t("../../data_structures/queue.js"),
                i = function (t, r) {
                  var i = new e();
                  i.push(t);
                  for (var n; !i.isEmpty(); )
          ...
          31: [
            function (t, r) {
              ...
              var e = t("../../util/comparator"),
                i = function (t, r) {
                  for (
                    var i = new e(r), n = t.length, o = n - 1, s = !1, a = 0;
                    n - 1 > a;
                    a++
                  ) {
          ...
          32: [
            function (t, r) {
              ...
              var e = function (t) {
                  ...
                  for (r = 0; e >= r; r++)
                    if (void 0 !== n[r])
                      for (var h = n[r].length, u = 0; h > u; u++)
                        t[a++] = n[r][u];
                  return t;
                },
                i = function (t) {
          ...
          33: [
            function (t, r) {
              "use strict";
              var e = t("../../data_structures/heap").MinHeap,
                i = function (t, r) {
                  var i = new e(r);
                  i.heapify(t);
          ...
          34: [
            function (t, r) {
              ...
              var e = t("../../util/comparator"),
                i = function (t, r) {
                  for (var i = new e(r), n = 1, o = t.length; o > n; n++) {
                    for (
                      var s = t[n], a = n;
                      a > 0 && i.lessThan(s, t[a - 1]);
            ...
            function (t, r) {
              ...
              var e = function (t) {
                ...
                i = function (t, r) {
                  ...
                  for (e = 0; i > e; e++) {
                    var o =
                      parseInt((t[e].key / Math.pow(10, r)).toFixed(r)) % 10;
                    n[o].push(t[e]);
                  }
                  var s = 0;
                  for (e = 0; 10 > e; e++)
                    for (var a = n[e].length, h = 0; a > h; h++)
                      t[s++] = n[e][h];
                  return t;
                },
                n = function (t) {
          ...
          38: [
            function (t, r) {
              ...
              var e = t("../../util/comparator"),
                i = function (t, r) {
                  for (var i = new e(r), n = t.length, o = 0; n - 1 > o; o++) {
              ...
              (e.encode = function (t, r) {
                ...
                for (
                  ...
                  var f = l(),
                    p = l();
                  (f.code = "0"), (p.code = "1");
                  var g = { count: f.count + p.count, parts: [f, p] };
                  a.push(g);
                }
                var d = l();
                (d.code = i.length > 1 ? "" : "0"),
            ...
            function (t, r) {
              ...
              var e = 997,
                i = function (t, r) {
                  ...
                  for (
                    var i, o = n(r), s = t.substring(0, r.length), a = r.length;
                    a <= t.length;
                    a++
                  )
                    if (
                      (void 0 === i
                        ? (i = n(s))
                        : ((i -= s.charCodeAt(0) * Math.pow(e, r.length - 1)),
                          (i *= e),
                          (i += t.charCodeAt(a)),
                          (s = s.substring(1) + t[a])),
                      o === i && r === s)
                ...
                n = function (t) {
                  for (var r = 0, i = 0; i < t.length; i++)
                    r += t.charCodeAt(i) * Math.pow(e, t.length - i - 1);
                  return r;
                };
              r.exports = i;
            },
          ...
          49: [
            function (t, r) {
              ...
              (e.prototype.getNodeHeight = function (t) {
                var r = 1;
                return (
                  null !== t.left && null !== t.right
                    ? (r = Math.max(t.left.height, t.right.height) + 1)
                    : null !== t.left
                    ? (r = t.left.height + 1)
                    : null !== t.right && (r = t.right.height + 1),
                  r
                );
              }),
                (e.prototype.isNodeBalanced = function (t) {
                  var r = !0;
                  return (
                    null !== t.left && null !== t.right
                      ? (r = Math.abs(t.left.height - t.right.height) <= 1)
                      : null !== t.right && null === t.left
                      ? (r = t.right.height < 2)
                      : null !== t.left &&
                        null === t.right &&
                        (r = t.left.height < 2),
                ...
                (e.prototype.getNodesToRestructureAfterRemove = function (t) {
                  var r,
                    e = t.length - 1,
                    i = t[e];
                ...
                (e.prototype.getNodesToRestructureAfterInsert = function (t) {
                  var r,
                    e = t.length - 1,
                    i = t[e],
                    n = t.length - 2,
                ...
                (e.prototype.rightRight = function (t, r, e) {
                  if (null !== e.parent) {
                    var i = e.parent.left === e ? "left" : "right";
            ...
            function (t, r) {
              ...
              (e.prototype = new i()),
                ...
                (e.prototype.extract = function (t) {
                  var r = i.prototype.extract.call(this);
