    ...
    (e.prototype.wrapCallback = function (e) {
      ...
      return function (r, n) {
        r ? t.reject(r) : t.resolve(n),
          "function" == typeof e &&
            (t.promise.catch(function () {}), 1 === e.length ? e(r) : e(r, n));
      };
    }),
    e
  );
  ...
  A = (function () {
    ...
    return (
      ...
      (e.prototype.setComponent = function (e) {
        ...
        try {
          for (
            var n = o(this.instancesDeferred.entries()), i = n.next();
            !i.done;
            i = n.next()
          ) {
            var s = a(i.value, 2),
...
var z,
  ...
  G = (function () {
    function e(e, t, r) {
      ...
      try {
        for (
          var s = o(this.firebase_.INTERNAL.components.values()), u = s.next();
          !u.done;
          u = s.next()
        ) {
          var l = u.value;
...
function $(e) {
  ...
  function i(e) {
    if (!O(t, (e = e || "[DEFAULT]"))) throw V.create("no-app", { appName: e });
    return t[e];
  }
  function a(a) {
    var s,
    ...
    if (r.has(l))
      return (
        W.debug(
          "There were multiple attempts to register component " + l + "."
        ),
